 ...
 <div class="main">
    <div class="content">
		...
		<div class="cont-desc span_1_of_2">				
				...
				<div class="desc span_3_of_2" style="font-size: 1.4em;color: #000 !important;">
					<h2 style="color: #000 !important;"><?php echo $result_details['productName'] ?></h2>
					<p  style="color: #000 !important;"><?php echo $fm->textShorten($result_details['product_desc'],150) ?></p>					
					<div class="price" style="color: #000 !important;">
						<p style="color: #000 !important;" >Price: <span><?php echo $fm->format_currency($result_details['price'])." "."VNĐ" ?></span></p>
						<p  style="color: #000 !important;">Category: <span><?php echo $result_details['catName'] ?></span></p>
						<p  style="color: #000 !important;">Brand:<span><?php echo $result_details['brandName']?></span></p>
					</div>
				<div class="add-cart">
					<form action="" method="post">
						<input style="width: 220px !important;" type="number" class="buyfield" name="quantity" value="1" min="1"/>
