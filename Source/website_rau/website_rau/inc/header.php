		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div class="header_top_right">
			    ...
			    <div class="shopping_cart" style="width: 300px !important; text-align: center;">
					<div class="cart">
								...
								<span class="no_product">
									...
									$check_cart = $ct->check_cart();
										if($check_cart){
											$sum = Session::get("sum");
											$qty = Session::get("qty");
											echo $fm->format_currency($sum).' '.'đ'.'-'.'Số lượng:'.$qty ;
											}else{
											echo 'Empty';
										}
			...
			?>
		   <div class="login" style="margin-top: 20px;margin-left: 210px;">
			<?php
